...
func (c *datastoreProtobufClient) WriteData(ctx context.Context, in *WriteRequest) (*WriteResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "datastore")
...
const DatastorePathPrefix = "/twirp/datastore.Datastore/"
...
func (s *datastoreServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/datastore.Datastore/WriteData":
		s.serveWriteData(ctx, resp, req)
		return
	case "/twirp/datastore.Datastore/ReadData":
		s.serveReadData(ctx, resp, req)
		return
	case "/twirp/datastore.Datastore/DeleteData":
