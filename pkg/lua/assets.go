...
func decryptLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "decrypt.lua", size: 852, mode: os.FileMode(420), modTime: time.Unix(1556067344, 0)}
...
func encryptLua() (*asset, error) {
	...
	info := bindataFileInfo{name: "encrypt.lua", size: 1195, mode: os.FileMode(420), modTime: time.Unix(1556067215, 0)}
